                ...
                <div className="bg-inherit gap-4 mb-8">
                  ...
                  <div className="bg-inherit">
                    <input
                      ...
                      type='text'
                      className="bg-inherit rounded-lg border-solid border-[1px] border-[#075B61] opacity-[30%] w-full h-[49px] px-4 text-black" />
                  </div>
                </div>
                <div className="bg-inherit gap-4 mb-8">
                  <div className="bg-inherit not-italic font-medium text-[#075B61] text-base">
                  ...
                  <div className="bg-inherit">
                    <select
                      ...
                      type='select'
                      className="bg-inherit rounded-lg border-solid border-[1px] border-[#075B61] opacity-[30%] w-full h-[49px] px-4 text-[#075B61] "
                    >
